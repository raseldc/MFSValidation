...
public class Constant {
    ...
    public static final int STATUS_INTERMIDIATE = 101;


    public static final int ACCOUNT_TYPE_BANK_SAVING = 1;
    public static final int ACCOUNT_TYPE_MFS = 2;
    public static final int ACCOUNT_TYPE_BANK_CURRENT = 4;
    public static final int ACCOUNT_TYPE_POST_OFFICE = 5;


    public static final int WALLET_BKASH = 1;
    ...
    public static final int WALLET_SIBL_MFS = 31;
